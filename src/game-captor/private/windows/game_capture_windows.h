...
typedef struct LocalHookWindowInfo_t :CaptureWindowHandle_t {
    ...
    CommonHandlePtr_t SharedMemHandle;
    uint64_t WindowID{ 0 };
...
typedef struct LocalHookInfo_t :CaptureProcessHandle_t {
    ...
    CommonHandlePtr_t keepalive_mutex{};
    CommonHandlePtr_t hook_init{};
    CommonHandlePtr_t hook_restart{};
    CommonHandlePtr_t hook_stop{};
    CommonHandlePtr_t hook_ready{};
    CommonHandlePtr_t hook_exit{};
    HANDLE hook_data_map{ NULL };
    CommonHandlePtr_t texture_mutexes[2]{};

    std::vector<std::shared_ptr<LocalHookWindowInfo_t>> Windows;
    hook_info_t* shared_hook_info;
    CommonHandlePtr_t shared_mem_handle;
...
public:
    ...
    void ShowOverlayWindow(CaptureWindowHandle_t* windowHanlde) override;
    void HideOverlayWindow(CaptureWindowHandle_t* windowHanlde) override;
